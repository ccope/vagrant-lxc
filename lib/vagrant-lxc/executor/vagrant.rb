...
module Vagrant
  module LXC
    module Executor
      # The Vagrant executor runs commands over SSH against the given
      ...
      class Vagrant
        ...
        def execute(*cmd, **opts, &block)
          ...
          cmd.unshift wrapper if wrapper
          ...
          # We have to do this to avoid catching any MOTD/login message in our output
          start_fence = "========== VAGRANT LXC BEGIN =========="
